---
name: web-research
description: Use quando precisar buscar documentação oficial, validar informações técnicas em fontes primárias, comparar versões de APIs ou sintetizar conhecimento de múltiplas fontes verificáveis.
license: MIT
---
